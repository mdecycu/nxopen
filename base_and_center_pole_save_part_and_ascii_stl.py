...
def main() : 
    ...
    if os.path.exists(current_directory + "\\" + prt_file_name + ".prt"):
        # 若希望存檔的零件存在, 則先刪除該零件檔案
        os.remove(current_directory + "\\" + prt_file_name + ".prt")
    ...
    stlFilename = current_directory + "\\base_w_center_pole_ascii_stl.txt"
