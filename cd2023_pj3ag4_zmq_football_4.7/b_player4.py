...
def setBubbleRobVelocity(leftWheelVelocity1, rightWheelVelocity1,leftWheelVelocity2, rightWheelVelocity2):
    leftMotor1 = sim.getObject('/b_player4/joint_lf')
    rightMotor1 = sim.getObject('/b_player4/joint_rf')
    leftMotor2 = sim.getObject('/b_player4/joint_lb')
    rightMotor2 = sim.getObject('/b_player4/joint_rb')
...
def setBubbleRobangel(a):
    brickRob= sim.getObject('/b_player4')
    angel = [-90*math.pi/180, a*math.pi/180, 0*math.pi/180]
    leftMotor = sim.getObject('/b_player4/joint_lf')
    rightMotor = sim.getObject('/b_player4/joint_rf')
